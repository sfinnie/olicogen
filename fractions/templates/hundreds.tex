...
\documentclass[preview]{standalone} % we only want the diagram: this crops the pdf to the size of the content
...
\begin{document}
%\maketitle
\thispagestyle{empty} % don't print page numbers - we only want the diagram
% ---------------------------------------------------------------
